...
resource "aviatrix_transit_firenet_policy" "ew_transit_firenet_policy1" {
  transit_firenet_gateway_name = aviatrix_transit_gateway.ew_transit_firenet_gw.gw_name
  inspected_resource_name      = "SPOKE:avx-firenet-spoke-gw-0"
  depends_on = [aviatrix_firenet.ew_firewall_net]
}

resource "aviatrix_transit_firenet_policy" "ew_transit_firenet_policy2" {
  transit_firenet_gateway_name = aviatrix_transit_gateway.ew_transit_firenet_gw.gw_name
